...
const styles = StyleSheet.create({
  ...
  tabBar: { paddingLeft: spacing.md, paddingRight: spacing.xl, paddingVertical: spacing.sm, gap: spacing.sm },
  tab: { paddingHorizontal: spacing.md, paddingVertical: spacing.sm, borderRadius: borderRadius.full, backgroundColor: colors.surface, flexShrink: 0 },
