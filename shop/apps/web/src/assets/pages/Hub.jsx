...
const SectionTitle = ({ eyebrow, title, subtitle, light = false }) => (
  <FadeIn className="text-center mb-14 md:mb-16">
    {eyebrow && (
      <span className={`inline-flex items-center px-3 py-1 rounded-full text-[11px] font-bold tracking-[0.18em] uppercase mb-5 border ${
        light
          ? 'text-blue-200 border-blue-400/30 bg-blue-400/10'
          : 'text-blue-600 border-blue-200 bg-blue-50 dark:text-blue-400 dark:border-blue-400/30 dark:bg-blue-400/10'
      }`}>
        {eyebrow}
      </span>
    )}
  ...
  return (
    <>
      ...
      <section className="relative min-h-[88vh] flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 via-white to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 overflow-hidden">
        ...
        {/* Dot grid */}
        <div aria-hidden="true" className="absolute inset-0 opacity-[0.04] dark:opacity-[0.06] pointer-events-none"
