      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link to="/" className="flex-shrink-0 ml-4">
            <img src="/cropped-vtech-logo.webp" alt="VTech Kitchen" width={63} height={56} className="h-14 w-auto object-contain dark:ring-2 dark:ring-white/50 dark:rounded-xl dark:p-1" />
          </Link>
