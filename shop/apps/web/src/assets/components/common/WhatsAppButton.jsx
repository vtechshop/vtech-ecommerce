  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
        ...
        <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-3 space-y-2 mb-1">
          {numbers.map((n) => (
            <a
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-blue-50 transition-colors text-sm font-medium text-gray-800"
            >
      ...
      <button
        ...
        className="bg-blue-500 hover:bg-blue-600 text-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
