...
export const DISTRICTS = {
  ...
  'Andhra Pradesh': [
    ...
    'Prakasam','Sri Potti Sri Ramulu Nellore','Sri Sathya Sai','Srikakulam',
  ...
  'Chhattisgarh': [
    ...
    'Raigarh','Raipur','Rajnandgaon','Sakti','Sarangarh-Bilaigarh','Sukma',
    'Surajpur','Surguja',
  ],
  'Punjab': [
    ...
    'Rupnagar','SAS Nagar','Sangrur','Tarn Taran',
  ],
  'Haryana': [
  ...
  'Nagaland': [
    ...
    'Mon','Niuland','Noklak','Peren','Phek','Tseminyü','Tuensang',
    'Wokha','Zunheboto',
  ],
  'Arunachal Pradesh': [
