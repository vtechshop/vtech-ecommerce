...
router.post('/products/assign-category', authenticate, authorize(['vendor', 'admin']), requireApprovedKYC, vendorController.assignProductsToCategory);
router.post('/products/remove-from-category', authenticate, authorize(['vendor', 'admin']), requireApprovedKYC, vendorController.removeProductsFromCategory);
